...
class SecureVaultService {
  ...
  static final SecureVaultService _instance = SecureVaultService._privateConstructor();
  ...
  Future<void> initialize() async {
    try {
      final storedKeyBase64 = await _secureStorage.read(key: _encryptionKeyStorageKey);
      ...
      throw Exception('Gagal menginisialisasi Secure Vault: Operasi penyimpanan aman ditolak.');
    }
  }
  ...
  String decryptData(String encryptedBase64) {
    ...
    try {
      ...
      if (combinedBytes.length < 16) {
        throw Exception('Integritas data terkompromi: Panjang paket tidak valid.');
      }
